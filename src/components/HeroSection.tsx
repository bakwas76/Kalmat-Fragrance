...
//   className="inline-flex translate-y-52 items-center gap-3 border-b border-gold pb-1.5 text-[11px] font-medium uppercase text-gold-light transition-all duration-300 hover:gap-5"
      ...
      <div className="relative z-10 flex h-full items-center justify-center">
        <div className="kx-container py-20 text-center">
          <motion.div
            ...
            className="flex flex-col items-center"
          >
            <h1 className="max-w-3xl text-center font-display text-3xl font-light leading-tight text-ivory sm:text-4xl lg:text-5xl">
              {banner?.title || 'Luxury Handcrafted Perfumes — Oud, Rose & Amber Fragrances'}
            </h1>
            <p className="mt-5 max-w-xl text-center text-sm font-light leading-relaxed text-ivory/80 sm:text-base">
