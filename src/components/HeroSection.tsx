...
export default function HeroSection() {
  ...
  className="inline-flex translate-y-32 items-center gap-3 border-b border-gold pb-1.5 text-[11px] font-medium uppercase text-gold-light transition-all duration-300 hover:gap-5"
